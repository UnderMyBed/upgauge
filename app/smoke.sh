...
check_not "carrier: 404 (ZZ) is not long-cached"        "$HDRS" "s-maxage=2592000"
...
check_not "carrier: 404 (PA) is not long-cached"             "$HDRS" "s-maxage=2592000"
...
check_not "sitemap: ...not the current build month"                    "$VX_BLOCK" '2026-04-01'
