 ...
 *
 * They disagree for 215 of 22,635 routes (0.95%, excluding the 532 same-airport "routes"
 ...
 * Conflating them would query the wrong route for that 0.95%, or mint a URL nobody would
 * type. */
