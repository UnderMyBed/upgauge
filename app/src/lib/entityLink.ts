 ...
 * for 215 of 22,635 pairs (CLAUDE.md; routePair.ts computes them as two separate values for
 * exactly this reason). Building an href from the displayed order is right 99.05% of the time,
