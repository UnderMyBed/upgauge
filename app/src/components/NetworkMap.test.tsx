...
describe("NetworkMap", () => {
  ...
  it("draws real American Samoa coastline for a network reaching `sam` (#111)", () => {
    ...
    // projects to (1006.8, 771.6), off a 960x500 canvas, so `sam` is a panel and not a rect
    // tweak. A page reaching it must get its own labelled frame with real land under the dot.
  ...
  it("keeps Midway's own node on the canvas", () => {
    ...
    // project it to (1635.6, -207.7) -- off a 960x500 canvas -- and `/airport/MDY?y=2021`
