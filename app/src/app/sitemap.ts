 ...
 *
 * **23,913** URLs, quarantine-inclusive throughout (`sql/03_queries/sitemap_routes.sql`'s
 * header: a quarantined row is still a real filing and a real 200-serving page) --
 * `docs/product/scope.md` § D2 records the entity-page breakdown: 22,635 routes + 1,049
 * airports + 114 carriers + 110 aircraft (23,908), plus M6 Task 7's `/watch` + its four
 * presets (+5) = 23,913. Well under Google's 50,000-URL-per-sitemap limit, so one sitemap file
