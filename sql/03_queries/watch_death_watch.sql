...
--
-- The reason this guarantee matters at all: 361 of the 5,675 carrier-route pairs in
-- mart_route_health have a NULL health_score for one of three data-availability reasons:
-- 281 no prior window, 93 no filed schedule, overlap 13 (docs/product/features.md). A NULL
