...
| `make app-check` | 1,652 app tests · without a built `upgauge.duckdb` only 1,509 are COLLECTED and 542 of those fail — the two figures count different sets, so "N of the total fail" was never the sentence it read as |
