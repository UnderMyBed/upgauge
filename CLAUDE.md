...
| `make app-check` | 1,773 app tests · without a built `upgauge.duckdb` only 1,757 are COLLECTED and 630 of those fail — the two figures count different sets, so "N of the total fail" was never the sentence it read as |
