...
| `make app-check` | 1,826 app tests · without a built `upgauge.duckdb` only 1,810 are COLLECTED and 649 of those fail — the two figures count different sets, so "N of the total fail" was never the sentence it read as |
